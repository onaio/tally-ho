...
from libya_tally.libs.middleware.idle_timeout import IdleTimeout
...
class TestMiddleware(TestCase):
    ...
    @patch('libya_tally.libs.middleware.idle_timeout.time')
    ...
    @patch('libya_tally.libs.middleware.idle_timeout.datetime')
