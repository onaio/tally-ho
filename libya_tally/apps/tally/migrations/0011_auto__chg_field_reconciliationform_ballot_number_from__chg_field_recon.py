...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReconciliationForm.ballot_number_from'
        db.alter_column(u'tally_reconciliationform', 'ballot_number_from', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'ReconciliationForm.ballot_number_to'
        db.alter_column(u'tally_reconciliationform', 'ballot_number_to', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'ReconciliationForm.ballot_number_from'
        db.alter_column(u'tally_reconciliationform', 'ballot_number_from', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'ReconciliationForm.ballot_number_to'
        db.alter_column(u'tally_reconciliationform', 'ballot_number_to', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        'tally.audit': {
            ...
            'resolution_recommendation': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'result_form': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tally.ResultForm']"}),
