...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultForm.is_replacement'
        db.add_column(u'tally_resultform', 'is_replacement',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultForm.is_replacement'
        db.delete_column(u'tally_resultform', 'is_replacement')
