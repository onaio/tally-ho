...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Audit.action_prior_to_recommendation'
        db.alter_column(u'tally_audit', 'action_prior_to_recommendation', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Audit.action_prior_to_recommendation'
        db.alter_column(u'tally_audit', 'action_prior_to_recommendation', self.gf('django.db.models.fields.IntegerField')())
