...
from tally_system.apps.tally.forms.login_form import LoginForm
from tally_system.apps.tally.forms.password_change import PasswordChangeForm
...
handler403 = 'tally_system.apps.tally.views.home.permission_denied'
handler404 = 'tally_system.apps.tally.views.home.not_found'
handler400 = 'tally_system.apps.tally.views.home.bad_request'
handler500 = 'tally_system.apps.tally.views.home.server_error'
