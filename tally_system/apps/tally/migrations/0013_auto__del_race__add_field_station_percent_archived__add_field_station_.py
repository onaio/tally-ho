...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Station.percent_archived'
        db.add_column(u'tally_station', 'percent_archived',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Station.percent_received'
        db.add_column(u'tally_station', 'percent_received',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Station.percent_archived'
        db.delete_column(u'tally_station', 'percent_archived')

        # Deleting field 'Station.percent_received'
        db.delete_column(u'tally_station', 'percent_received')
