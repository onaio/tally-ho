...
class ResultFormSearchView(
    ...
    group_required = groups.TALLY_MANAGER
    template_name = "tally_manager/result_form_search.html"
...
class ResultFormHistoryView(
    ...
    group_required = groups.TALLY_MANAGER
    template_name = "tally_manager/result_form_history.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context['error'] = f'Result form with barcode "{barcode}" does not exist'
            return context
