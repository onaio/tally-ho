...
class TallyForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["print_cover_in_intake"].label = _(
            "Enable Cover Printing in Intake"
        )
        self.fields["print_cover_in_clearance"].label = _(
            "Enable Cover Printing in Clearance"
        )
        self.fields["print_cover_in_quality_control"].label = _(
