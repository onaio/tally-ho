...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Office', fields ['name']
        db.delete_unique(u'tally_office', ['name'])

        # Removing unique constraint on 'ResultForm', fields ['barcode']
        db.delete_unique(u'tally_resultform', ['barcode'])

        # Removing unique constraint on 'ResultForm', fields ['serial_number']
        db.delete_unique(u'tally_resultform', ['serial_number'])

        # Removing unique constraint on 'Center', fields ['code']
        db.delete_unique(u'tally_center', ['code'])

        # Adding unique constraint on 'Center', fields ['code', 'tally']
        db.create_unique(u'tally_center', ['code', 'tally_id'])

        # Adding field 'ResultForm.tally'
        db.add_column(u'tally_resultform', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='result_forms', null=True, to=orm['tally.Tally']),
                      keep_default=False)

        # Adding unique constraint on 'ResultForm', fields ['serial_number', 'tally']
        db.create_unique(u'tally_resultform', ['serial_number', 'tally_id'])

        # Adding unique constraint on 'ResultForm', fields ['barcode', 'tally']
        db.create_unique(u'tally_resultform', ['barcode', 'tally_id'])

        # Adding unique constraint on 'Office', fields ['name', 'tally']
        db.create_unique(u'tally_office', ['name', 'tally_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Office', fields ['name', 'tally']
        db.delete_unique(u'tally_office', ['name', 'tally_id'])

        # Removing unique constraint on 'ResultForm', fields ['barcode', 'tally']
        db.delete_unique(u'tally_resultform', ['barcode', 'tally_id'])

        # Removing unique constraint on 'ResultForm', fields ['serial_number', 'tally']
        db.delete_unique(u'tally_resultform', ['serial_number', 'tally_id'])

        # Removing unique constraint on 'Center', fields ['code', 'tally']
        db.delete_unique(u'tally_center', ['code', 'tally_id'])

        # Adding unique constraint on 'Center', fields ['code']
        db.create_unique(u'tally_center', ['code'])

        # Deleting field 'ResultForm.tally'
        db.delete_column(u'tally_resultform', 'tally_id')

        # Adding unique constraint on 'ResultForm', fields ['serial_number']
        db.create_unique(u'tally_resultform', ['serial_number'])

        # Adding unique constraint on 'ResultForm', fields ['barcode']
        db.create_unique(u'tally_resultform', ['barcode'])

        # Adding unique constraint on 'Office', fields ['name']
        db.create_unique(u'tally_office', ['name'])
    ...
    models = {
        ...
        'tally.userprofile': {
            ...
            'tally': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'to': "orm['tally.Tally']"}),
