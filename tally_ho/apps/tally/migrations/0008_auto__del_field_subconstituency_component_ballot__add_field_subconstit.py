...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubConstituency.component_ballot'
        db.delete_column(u'tally_subconstituency', 'component_ballot')

        # Adding field 'SubConstituency.ballot_component'
        db.add_column(u'tally_subconstituency', 'ballot_component',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sc_component', null=True, to=orm['tally.Ballot']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SubConstituency.component_ballot'
        db.add_column(u'tally_subconstituency', 'component_ballot',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'SubConstituency.ballot_component'
        db.delete_column(u'tally_subconstituency', 'ballot_component_id')
