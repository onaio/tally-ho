...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tally_resultform', 'barcode', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'ResultForm.barcode'
        db.alter_column(u'tally_resultform', 'barcode', self.gf('django.db.models.fields.CharField')(max_length=9, unique=True))
