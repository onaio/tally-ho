...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ballot.active'
        db.add_column(u'tally_ballot', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Ballot.disable_reason'
        db.add_column(u'tally_ballot', 'disable_reason',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ballot.active'
        db.delete_column(u'tally_ballot', 'active')

        # Deleting field 'Ballot.disable_reason'
        db.delete_column(u'tally_ballot', 'disable_reason')
