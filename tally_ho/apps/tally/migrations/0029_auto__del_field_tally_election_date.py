...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tally.election_date'
        db.delete_column(u'tally_tally', 'election_date')


    def backwards(self, orm):
        # Adding field 'Tally.election_date'
        db.add_column(u'tally_tally', 'election_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 18, 0, 0)),
                      keep_default=False)
