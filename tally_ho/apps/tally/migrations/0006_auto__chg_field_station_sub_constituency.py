...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Station.sub_constituency'
        db.alter_column(u'tally_station', 'sub_constituency_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tally.SubConstituency']))

    def backwards(self, orm):

        # Changing field 'Station.sub_constituency'
        db.alter_column(u'tally_station', 'sub_constituency_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tally.SubConstituency']))
