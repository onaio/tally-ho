...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Station.disable_reason'
        db.add_column(u'tally_station', 'disable_reason',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Station.disable_reason'
        db.delete_column(u'tally_station', 'disable_reason')
