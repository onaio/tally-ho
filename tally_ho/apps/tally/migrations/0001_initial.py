# Generated by Django 2.1.1 on 2018-09-09 23:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_prior_to_recommendation', enumfields.fields.EnumField(blank=True, default=4, enum=tally_ho.libs.models.enums.actions_prior.ActionsPrior, max_length=10, null=True)),
                ('resolution_recommendation', enumfields.fields.EnumField(blank=True, default=0, enum=tally_ho.libs.models.enums.audit_resolution.AuditResolution, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race_type', enumfields.fields.EnumField(enum=tally_ho.libs.models.enums.race_type.RaceType, max_length=10)),
            ],
            options={
                'ordering': ['number'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('center_type', enumfields.fields.EnumField(enum=tally_ho.libs.models.enums.center_type.CenterType, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other', models.TextField(blank=True, null=True)),
                ('action_prior_to_recommendation', enumfields.fields.EnumField(blank=True, default=4, enum=tally_ho.libs.models.enums.actions_prior.ActionsPrior, max_length=10, null=True)),
                ('resolution_recommendation', enumfields.fields.EnumField(blank=True, default=0, enum=tally_ho.libs.models.enums.clearance_resolution.ClearanceResolution, max_length=10, null=True)),
                ('team_comment', models.TextField(blank=True, null=True)),
                ('supervisor_comment', models.TextField(blank=True, null=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True)),
                ('entry_version', enumfields.fields.EnumField(enum=tally_ho.libs.models.enums.entry_version.EntryVersion, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_state', enumfields.fields.EnumField(enum=tally_ho.libs.models.enums.form_state.FormState, max_length=10)),
                ('gender', enumfields.fields.EnumField(enum=tally_ho.libs.models.enums.gender.Gender, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('gender', enumfields.fields.EnumField(enum=tally_ho.libs.models.enums.gender.Gender, max_length=10)),
