...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.tally'
        db.add_column(u'tally_userprofile', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='users', null=True, to=orm['tally.Tally']),
                      keep_default=False)

        # Adding M2M table for field administrated_tallies on 'UserProfile'
        m2m_table_name = db.shorten_name(u'tally_userprofile_administrated_tallies')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['tally.userprofile'], null=False)),
            ('tally', models.ForeignKey(orm['tally.tally'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'tally_id'])

        # Adding field 'Center.tally'
        db.add_column(u'tally_center', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='centers', null=True, to=orm['tally.Tally']),
                      keep_default=False)

        # Adding field 'Candidate.tally'
        db.add_column(u'tally_candidate', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='candidates', null=True, to=orm['tally.Tally']),
                      keep_default=False)

        # Adding field 'Office.tally'
        db.add_column(u'tally_office', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='offices', null=True, to=orm['tally.Tally']),
                      keep_default=False)

        # Adding field 'Ballot.tally'
        db.add_column(u'tally_ballot', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ballots', null=True, to=orm['tally.Tally']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.tally'
        db.delete_column(u'tally_userprofile', 'tally_id')

        # Removing M2M table for field administrated_tallies on 'UserProfile'
        db.delete_table(db.shorten_name(u'tally_userprofile_administrated_tallies'))

        # Deleting field 'Center.tally'
        db.delete_column(u'tally_center', 'tally_id')

        # Deleting field 'Candidate.tally'
        db.delete_column(u'tally_candidate', 'tally_id')

        # Deleting field 'Office.tally'
        db.delete_column(u'tally_office', 'tally_id')

        # Deleting field 'Ballot.tally'
        db.delete_column(u'tally_ballot', 'tally_id')
    ...
    models = {
        ...
        'tally.resultform': {
            ...
            'barcode': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
