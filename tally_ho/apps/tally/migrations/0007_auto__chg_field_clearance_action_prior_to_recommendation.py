...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Clearance.action_prior_to_recommendation'
        db.alter_column(u'tally_clearance', 'action_prior_to_recommendation', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Clearance.action_prior_to_recommendation'
        db.alter_column(u'tally_clearance', 'action_prior_to_recommendation', self.gf('django.db.models.fields.IntegerField')())
