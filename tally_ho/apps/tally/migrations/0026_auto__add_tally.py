...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tally_tally', (
            ...
            ('disable_reason', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, db_index=True)),
        ))
        db.send_create_signal('tally', ['Tally'])


    def backwards(self, orm):
        # Deleting model 'Tally'
        db.delete_table(u'tally_tally')
