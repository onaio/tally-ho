...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResultForm.clearance_printed'
        db.add_column(u'tally_resultform', 'clearance_printed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResultForm.clearance_printed'
        db.delete_column(u'tally_resultform', 'clearance_printed')
