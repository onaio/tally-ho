...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubConstituency.tally'
        db.add_column(u'tally_subconstituency', 'tally',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sub_constituencies', null=True, to=orm['tally.Tally']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubConstituency.tally'
        db.delete_column(u'tally_subconstituency', 'tally_id')
