...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuarantineCheck.percentage'
        db.add_column(u'tally_quarantinecheck', 'percentage',
                      self.gf('django.db.models.fields.FloatField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuarantineCheck.percentage'
        db.delete_column(u'tally_quarantinecheck', 'percentage')
