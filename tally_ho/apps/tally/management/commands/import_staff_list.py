...
STAFF_ROLE_DICT = {
    ...
    'QUALITY CONTROL_ARCHIVE': groups.QUALITY_CONTROL_ARCHIVE_CLERK,
    'QUALITY CONTROL_ARCHIVE_CLERK': groups.QUALITY_CONTROL_ARCHIVE_CLERK,
    'QUALITY_CONTROL_ARCHIVE_SUPERVISOR': groups.QUALITY_CONTROL_ARCHIVE_SUPERVISOR,
