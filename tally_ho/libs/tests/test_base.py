...
def create_reconciliation_form(
    ...
    return ReconciliationForm.objects.create(
        ...
        number_ballots_inside_and_outside_box=number_ballots_inside_and_outside_box,
        total_of_cancelled_ballots_and_ballots_inside_box=total_of_cancelled_ballots_and_ballots_inside_box,
