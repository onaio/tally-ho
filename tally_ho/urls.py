...
urlpatterns = patterns(
    ...
    url(r'^super-administrator/results/(?P<tally_id>(\d+))/$',
        super_admin.ResultExportView.as_view(),
        name='result-export'),
    url(r'^super-administrator/remove-center/(?P<tally_id>(\d+))/$',
        super_admin.RemoveCenterView.as_view(),
        name='remove-center'),
    url(r'^super-administrator/remove-center/(?P<tally_id>(\d+))/(?P<center_code>(\d+))$',
        super_admin.RemoveCenterConfirmationView.as_view(),
        name='remove-center-confirmation'),
    url(r'^super-administrator/edit-center/(?P<tally_id>(\d+))/(?P<center_code>(\d+))$',
