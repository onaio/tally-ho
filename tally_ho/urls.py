...
urlpatterns = patterns(
    ...
    url(r'^super-administrator/form-clearance-pendings$',
        super_admin.FormClearancePendingsView.as_view(),
        name='form-clearance-pendings'),
    url(r'^super-administrator/form-audit-pendings$',
        super_admin.FormAuditPendingsView.as_view(),
        name='form-audit-pendings'),
    ...
    url(r'^super-administrator/form-clearance-pending-data$',
        super_admin.FormClearancePendingDataView.as_view(),
        name='form-clearance-pending-data'),
    url(r'^super-administrator/form-audit-pending-data$',
        super_admin.FormAuditPendingDataView.as_view(),
        name='form-audit-pending-data'),
