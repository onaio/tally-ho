...
urlpatterns = [
    ...
    re_path(r'^super-administrator/form-audit/(?P<tally_id>(\d+))/$',
            ...
            name='form-audit'),
    re_path(r'^super-administrator/form-results-duplicates/(?P<tally_id>(\d+))/$',
    ...
    re_path(r'^super-administrator/results-(?P<report>.*).csv/(?P<tally_id>(\d+))/$',
    ...
    re_path(r'^super-administrator/remove-center/(?P<tally_id>(\d+))/$',
            ...
            name='remove-center'),
    re_path(r'^super-administrator/remove-center/(?P<tally_id>(\d+))/(?P<center_code>(\d+))$',
            super_admin.RemoveCenterConfirmationView.as_view(),
            name='remove-center-confirmation'),
    re_path(r'^super-administrator/edit-center/(?P<tally_id>(\d+))/(?P<center_code>(\d+))$',
            super_admin.EditCenterView.as_view(),
            name='edit-center'),
    re_path(r'^super-administrator/disable/(?P<tally_id>(\d+))/(?P<center_code>(\d+))/(?P<station_number>(\d+))?$',
            super_admin.DisableEntityView.as_view(),
            name='disable'),
    re_path(r'^super-administrator/enable/(?P<tally_id>(\d+))/(?P<center_code>(\d+))/(?P<station_number>(\d+))?$',
            super_admin.EnableEntityView.as_view(),
            name='enable'),
    re_path(r'^super-administrator/disablerace/(?P<tally_id>(\d+))/(?P<raceId>(\d+))$',
            super_admin.DisableRaceView.as_view(),
            name='disable-race'),
    re_path(r'^super-administrator/enablerace/(?P<tally_id>(\d+))/(?P<raceId>(\d+))$',
            super_admin.EnableRaceView.as_view(),
            name='enable-race'),
    re_path(r'^super-administrator/candidate-disable/(?P<tally_id>(\d+))/(?P<candidateId>(\d+))$',
            super_admin.DisableCandidateView.as_view(),
            name='candidate-disable'),
    re_path(r'^super-administrator/candidate-enable/(?P<tally_id>(\d+))/(?P<candidateId>(\d+))$',
    ...
    re_path(r'^super-administrator/quarantine-checks/config/(?P<checkId>(\d+))$',
            super_admin.QuarantineChecksConfigView.as_view(),
            name='quarantine-checks-config'),
    re_path(r'^super-administrator/remove-station/(?P<tally_id>(\d+))/(?P<center_code>(\d+))/(?P<station_number>(\d+))$',
            super_admin.RemoveStationConfirmationView.as_view(),
            name='remove-station-confirmation'),
    re_path(r'^super-administrator/edit-station/(?P<tally_id>(\d+))/(?P<center_code>(\d+))/(?P<station_number>(\d+))$',
    ...
    re_path(r'^data-entry/(?P<tally_id>(\d+))/$', data_entry.DataEntryView.as_view(),
            name='data-entry'),
    ...
    re_path(r'^intake/center-details/(?P<tally_id>(\d+))/$', intake.CenterDetailsView.as_view(),
            name='intake'),
    re_path(r'^intake/enter-center/(?P<tally_id>(\d+))/$', intake.EnterCenterView.as_view(),
    ...
    re_path(r'^audit/new',
            ...
            name='audit-new'),
    re_path(r'^audit/print',
            audit.PrintCoverView.as_view(),
            name='audit-print'),
    re_path(r'^audit/review$',
