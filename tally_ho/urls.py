...
urlpatterns = [
    ...
    re_path(r'^ajax/download-centers-by-mun-results/$',
            administrative_areas_reports.get_centers_by_municipalities_results,
            name='download-centers-by-mun-results'),
    re_path(r'^ajax/download-centers-by-mun-results-candidates-votes/$',
    ...
    re_path(r'^ajax/download-centers-stations-by-mun-results-candidates-votes/$',
